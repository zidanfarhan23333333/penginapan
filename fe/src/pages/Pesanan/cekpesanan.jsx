...
const cekpesanan = () => {
  return (
    <div className="flex min-h-screen items-center justify-center text-black">
      ...
      <div style={{width: 1520, height: 93, left: 55, top: 99, position: 'absolute', background: 'white', borderRadius: 10}} />      
      <div style={{left: 99, top: 0, position: 'absolute', color: 'black', fontSize: 32, fontFamily: 'Inter', fontWeight: '700', lineHeight: 24, wordWrap: 'break-word'}}>Pesanan anda</div>
      <Link
          to="/accommodations"
