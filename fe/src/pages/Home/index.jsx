  ...
  return (
    <div className="absolute top-0 right-0 bottom-0 w-1/2 h-full flex justify-center items-center pr-10 gap-2">
      ...
      {usaha.length === 0 ? (
        ...
        usaha.map((item) => (
          <div key={item.usaha_id} className="card bg-white rounded-lg shadow-md w-80">
            <img
...
const Index = () => {
  return (
    <div className="relative w-full h-screen">
      <img src={travel} alt="travel.jpg" className="w-full h-full object-cover" />
  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="relative w-full h-screen mt-4 ml-2 mr-2 p-4">
        <img src={MbakMbak} alt="MbakMbak.jpg" className="w-full h-full object-cover" />
