  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white bg-opacity-90 h-auto w-full max-w-md flex flex-col justify-center p-8 rounded shadow-lg gap-10 rounded-2xl">
          <div className="flex flex-col items-center justify-center py-3">
            <h1 className="mb-3">Borobudur Society.</h1>
